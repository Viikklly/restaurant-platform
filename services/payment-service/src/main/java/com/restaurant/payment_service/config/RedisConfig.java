package com.restaurant.payment_service.config;
...
public class RedisConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        return RedisCacheManager.builder(connectionFactory)
                ...
                // Добавляем специфичные конфигурации для кэшей
                ...
                .withCacheConfiguration("paymentList",
                        RedisCacheConfiguration.defaultCacheConfig()
    ...
    private GenericJackson2JsonRedisSerializer jacksonSerializer() {
        ...
        PolymorphicTypeValidator ptv = BasicPolymorphicTypeValidator.builder()
                /// Разрешаем пакеты Payment Service
                .allowIfSubType("com.restaurant.payment_service.entity")
                .allowIfSubType("com.restaurant.payment_service.dto")
                /// Разрешаем стандартные типы
