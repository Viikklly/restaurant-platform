...
function Show-Menu {
 ...
 10. Показать все URL
 11. Запуск только мониторинга для dev
 12. Логи мониторинга
 13. Проверить мониторинг
 14. Проверить Eureka
 15. Очистка Docker системы
 16. Полная очистка Docker (все образы + тома) ️(Все данные в томах будут удалены)
  0. Выход
...
do {
    Show-Menu
    $choice = Read-Host "Выберите действие (0-16)"
